...
export const TABLES = {
  ...
  DASHBOARD_MONTHLY_TRENDS:        'dashboard_monthly_trends',
  DASHBOARD_CONTRACT_SUMMARY:      'dashboard_contract_summary',
  DASHBOARD_TOP20:                 'dashboard_top20',
  DASHBOARD_CASH_BREAKDOWN:        'dashboard_cash_breakdown',
  DASHBOARD_PAYMENT_SCHEDULE:      'dashboard_payment_schedule',
