  ...
  return (
    <div className="min-h-screen bg-[#f6f7f8]">
                ...
                columns={[
                  {
                    key: 'company_name',
                    header: 'Company',
                    render: (doc) => <span className="font-medium text-slate-800">{doc.company_name}</span>
                  },
                  {
                    key: 'contract_start',
                  ...
                  },
                  {
                    ...
                    header: 'Action',
                    render: (doc) => (
                      <Badge variant={doc.action === 'esign' ? 'success' : 'info'}>
                  ...
                  },
                  {
                    key: 'generated_by',
                    header: 'Generated By',
                    render: (doc) => <span className="text-slate-500">{doc.generated_by || '—'}</span>
                  },
                  {
                    key: 'created_at',
                    header: 'Date',
      ...
      <Modal
        ...
        title="Send SLA for E-Signature"
        size="lg"
      >
